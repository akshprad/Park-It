...
public class GoogleSignInExtra extends AppCompatActivity implements View.OnClickListener{
        ...
        switch (v.getId()){
            case R.id.registerExtraBtnRegister:
                ...
                if (veriftData()){
                    ...
                    Toast.makeText(GoogleSignInExtra.this, "Registration successful", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(GoogleSignInExtra.this, GoogleSignInExtra.class);
